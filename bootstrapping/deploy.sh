...
terraform plan -var resource_group_name="$BACKEND_RESGRP" state_sa_name="$BACKEND_STORAGE_ACCOUNT" -var shared_acr_name="$SHARED_ACR_NAME" -var shared_keyvault_name="$SHARED_KEYVAULT_NAME" -out=tfplan $1
